...
interface LungesTrackerProps {
  onExerciseComplete: (data: ExerciseData) => void;
  onBack: () => void;
}

export const LungesTracker: React.FC<LungesTrackerProps> = ({
  onExerciseComplete,
  onBack
}) => {
        ...
        <Card className="mb-6">
          ...
          <CardContent>
            <p className="text-muted-foreground mb-4">
              Single-leg movement for balance and leg strength. Step forward, lower your hips, and return to starting position.
            </p>
