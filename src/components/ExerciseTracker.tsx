...
export const ExerciseTracker: React.FC<ExerciseTrackerProps> = ({
  ...
  const getExerciseInstructions = () => {
    switch (exerciseName.toLowerCase()) {
      case 'squats':
        return 'Stand with feet shoulder-width apart. Lower your hips back and down. Keep your chest up and knees behind toes.';
      case 'push-ups':
        return 'Start in plank position. Lower your chest to the ground. Push back up while maintaining straight line.';
      case 'planks':
        return 'Hold plank position with straight line from head to heels. Keep core engaged.';
      default:
        return 'Follow the exercise form and maintain good posture throughout the movement.';
    }
  };
